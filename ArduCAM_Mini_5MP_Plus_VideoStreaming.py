...
ledROJO = digitalio.DigitalInOut(board.GP18)
ledROJO.direction = digitalio.Direction.OUTPUT

ledVERDE = digitalio.DigitalInOut(board.GP19)
ledVERDE.direction = digitalio.Direction.OUTPUT

ledAZUL = digitalio.DigitalInOut(board.GP20)
ledAZUL.direction = digitalio.Direction.OUTPUT

ledBLANCO = digitalio.DigitalInOut(board.GP21)
